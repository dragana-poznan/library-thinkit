    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            ...
            <div class="container">
                ...
                <form method="post" action="{{ route('librarian.book.update') }}">
                    @csrf
                    <input type="hidden" name="id" value="{{$data->id}}">
                    <div class="form-group">
                        <label for="title">Book title</label>
                        <input name="title" type="text" class="form-control" id="title" placeholder="Add the book title"
                            value="{{ $data->title }}">
                        @error('title')
                    ...
                    <div class="form-group">
                        ...
                        <input name="book_no" type="text" class="form-control" id="book_no"
                            placeholder="Add the book number" value="{{ $data->book_no }}">
                        @error('book_no')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>
                    ...
                    <!-- <div class="form-group">
                        ...
                        <select name="author_id" class="form-control" id="author_id">
                            <option>Set the author from dropdown</option>
